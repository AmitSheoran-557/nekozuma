...
const Team = () => {
    return (
        <div id='team' className='bg-blue d-flex flex-column pt-md-5 pt-3 w-100 team-section justify-content-center align-items-center'>
                ...
                <div className="d-flex flex-wrap justify-content-center team-card-row">
                    {TEAM_MEMBERS_DATA_LIST.map((member, index) => (
                        <div key={index} className="text-light rounded text-center team-card" style={{ maxWidth: "202px" }}>
                            <Image className='w-100 team-member-img mx-auto' src={member.image} width={202} height={202} />
                            ...
                            <Link href={member.twitterLink} target='_blank'>
                                <Image className='mx-auto' src={member.twitterIcon} width={20} height={20} />
                            </Link>
                        </div>
                    ))}
                </div>
