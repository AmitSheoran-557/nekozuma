...
const Footer = () => {
    return (
        <div className='py-5 bg-blue-2 d-flex justify-content-center align-items-center position-relative flex-column'>
            <Image className='position-absolute footer-light-img-1 bottom-0 start-0' src="/assets/images/png/footer-left-vector.png" alt="light-img" />
            <Image className='position-absolute footer-light-img-2 end-0 bottom-0' src="/assets/images/png/footer-right-vector.png" alt="light-img-2" />
